...
2. **Deterministic read-only inventory behavior — deployed; protected manual verification pending**
   - Status: commit `e1de56d` passed CI and is live on Render. Local automated verification and the public unauthenticated smoke checks pass; the human's protected Bruno/browser checks remain.
